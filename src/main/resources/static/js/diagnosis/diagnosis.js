...
layui.use('core', function(){
    ...
    table.on('tool(tableFilter)', function(obj){
        var data = obj.data;
        if(obj.event === 'detail'){
            core.openIframeDialog('诊疗详情','/diagnosis/input?id='+data.id,['500px', '600px'],false,initTable);
        }
    });
