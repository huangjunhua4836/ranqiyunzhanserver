...
layui.use('core', function () {
    ...
    function initTable(where) {
        ...
        table.render({
                elem: '#table'
                , url: '/platform/opportunity/initTable' //数据接口
                , where: where
...
//监听行工具事件
    table.on('tool(tableFilter)', function (obj) {
        ...
        if (obj.event === 'del') {
            ...
            core.openIframeDialog('修改热资讯', '/platform/opportunity/input?type=update&id=' + data.id, ['100%', '90%'], false, initTable);
